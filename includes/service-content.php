...
function service_content_overrides(): array {
    return [
        'seo-services' => [
            ...
            'overview' => '<p>SEO drives sustainable organic traffic and qualified leads. At Nectra Digital, our SEO services combine technical mastery, content strategy, and ethical link building to help Indian businesses rank on Google for high-intent commercial keywords.</p><p>We focus on measurable outcomes — rankings, traffic, and conversions — not vanity metrics. From startups in Lucknow to enterprises targeting pan-India markets, every campaign includes transparent monthly reporting.</p><p>Led by <strong>' . FOUNDER_NAME . '</strong> (' . FOUNDER_TITLE . ') with ' . FOUNDER_EXPERIENCE . ' of hands-on SEO experience, every campaign follows EEAT principles and modern search best practices.</p>',
            'benefits' => [
