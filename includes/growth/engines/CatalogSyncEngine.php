...
class CatalogSyncEngine
{
    ...
    private static function servicePayload(string $slug, array $data, int $sortOrder): array
    {
        ...
        return [
            ...
            'meta_title_template' => 'Best {service_name} Company in {city_name} | Nectra Digital',
            'meta_description_template' => 'Top {service_name} company in {city_name}, {state}. Expert services, free consultation, proven ROI. Contact Nectra Digital.',
            'h1_template' => 'Best {service_name} Company in {city_name}',
            'h2_template' => 'Expert {service_name} in {state} · Nectra Digital',
