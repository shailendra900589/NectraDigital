...
class AeoEngine
{
    public static function generateFaqs(array $service, array $city, array $ctx): array
    {
        ...
        $baseFaqs = [
            ...
            ['q' => "Why choose Nectra Digital for {$sn} in {$cn}?", 'a' => "We combine deep {$cn} market knowledge with enterprise-grade execution. Dedicated account managers, 200+ projects delivered, 4.9★ client rating, and ROI-focused strategies set us apart in {$state}."],
