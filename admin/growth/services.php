...
<div class="ge-card">
    <form method="POST" enctype="multipart/form-data">
        <div class="row g-3">
            ...
            <div class="col-12"><label class="form-label">Content Template (HTML, optional)</label><textarea name="content_template" class="form-control" rows="4" placeholder="Leave empty for auto-generated unique content"><?php echo htmlspecialchars($item['content_template'] ?? ''); ?></textarea></div>
