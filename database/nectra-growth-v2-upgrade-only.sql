-- ============================================================
-- Nectra Digital — v2 UPGRADE ONLY
-- Use ONLY if you already imported schema.sql (v1) before
-- phpMyAdmin: Import this file into same database
-- Ignore errors like "Duplicate column" or "Can't DROP index"
-- ============================================================
...
ALTER TABLE ge_landing_pages ADD COLUMN industry_id INT UNSIGNED NOT NULL DEFAULT 0 AFTER city_id;
ALTER TABLE ge_landing_pages ADD COLUMN page_type ENUM('service_city','service_city_industry') NOT NULL DEFAULT 'service_city' AFTER industry_id;
ALTER TABLE ge_landing_pages ADD COLUMN h3 VARCHAR(500) DEFAULT NULL AFTER h2;
ALTER TABLE ge_landing_pages ADD COLUMN cta_json JSON DEFAULT NULL AFTER internal_links_json;
...
ALTER TABLE ge_keywords ADD COLUMN industry_id INT UNSIGNED NOT NULL DEFAULT 0 AFTER city_id;
ALTER TABLE ge_keywords ADD COLUMN landing_page_id INT UNSIGNED DEFAULT NULL AFTER industry_id;
