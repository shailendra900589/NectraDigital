-- Nectra Digital Growth Platform v2 — Enterprise Extension
-- Run after schema.sql via database/migrate.php
...
-- ============================================================
-- LANDING PAGES v2 columns (safe ALTERs)
-- ============================================================
-- industry_id: 0 = city-only page
ALTER TABLE ge_landing_pages ADD COLUMN IF NOT EXISTS industry_id INT UNSIGNED NOT NULL DEFAULT 0 AFTER city_id;
ALTER TABLE ge_landing_pages ADD COLUMN IF NOT EXISTS page_type ENUM('service_city','service_city_industry') NOT NULL DEFAULT 'service_city' AFTER industry_id;
ALTER TABLE ge_landing_pages ADD COLUMN IF NOT EXISTS h3 VARCHAR(500) DEFAULT NULL AFTER h2;
ALTER TABLE ge_landing_pages ADD COLUMN IF NOT EXISTS cta_json JSON DEFAULT NULL AFTER internal_links_json;
...
ALTER TABLE ge_keywords ADD COLUMN IF NOT EXISTS industry_id INT UNSIGNED NOT NULL DEFAULT 0 AFTER city_id;
ALTER TABLE ge_keywords ADD COLUMN IF NOT EXISTS landing_page_id INT UNSIGNED DEFAULT NULL AFTER industry_id;

-- ============================================================
-- CRM: CLIENTS, LEADS, PROJECTS, PROPOSALS, QUOTATIONS
-- ============================================================
...
-- ============================================================
-- GENERATION QUEUE (async batches for scale)
-- ============================================================
...
-- Default tools (admin can edit/delete — seeded once)
...
-- Founder author seed (admin editable)
